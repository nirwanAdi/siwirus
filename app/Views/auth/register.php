<?= $this->extend('auth/templetes/index'); ?>
<?= $this->section('title'); ?>
                            ...
                            <div class="p-5">
                                ...
                                <form action="<?= route_to('register') ?>" method="post" class="user">
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-user <?php if (session('errors.fullname')) : ?>is-invalid<?php endif ?>" name="fullname" placeholder="Full Name" value="<?= old('fullname') ?>">
                                    </div>
                                    <div class="form-group">
