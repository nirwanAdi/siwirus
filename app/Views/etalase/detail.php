                ...
                <div class="row no-gutters mt-2 ml-2 mr-2 mb-1">
                    ...
                    <div class="col-md-8" style="line-height: 1;">
                        <div class="card-body">
                            ...
                            <?php if ($transaksi_preorder->statustransaksi == 0) : ?>
                                <p class="mt-2 mb-1">Silahkan lakukan pembayaran ke nomor rekening <?= $transaksi_preorder->no_rekening; ?> atas nama <big><b><?= $transaksi_preorder->nama_pemilik; ?></b></big> dan upload bukti pembayaran ke tempat yang telah disediakan</p>
                            <?php endif; ?>
                        ...
                        <form action="/etalase/upload_bukti_pembayaran/<?= $transaksi_preorder->transaksiid; ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <textarea type="text" class="form-control <?= ($validation->hasError('keterangan')) ? 'is-invalid' : ''; ?>" id="keterangan" name="keterangan"></textarea>
                                    <div class="invalid-feedback">
