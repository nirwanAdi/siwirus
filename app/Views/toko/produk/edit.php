...
<h3 class="h3 mb-4 text-gray-800">Update Data Produk</h3>
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
        <form action="/produk/update/<?= $produk['kodeproduk']; ?>" method="POST" enctype="multipart/form-data">
    <?= csrf_field(); ?>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-6">
        <input type="text" class="form-control <?= ($validation->hasError('kodeproduk'))? 'is-invalid' : '' ; ?>" id="kodeproduk" name="kodeproduk" autofocus value="<?= (old('kodeproduk')) ? old('kodeproduk') : $produk['kodeproduk']; ?>">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-6">
        <input type="text" class="form-control <?= ($validation->hasError('namaproduk'))? 'is-invalid' : '' ; ?>" id="namaproduk" name="namaproduk" value="<?= (old('namaproduk')) ? old('namaproduk') : $produk['namaproduk']; ?>">
        <div class="invalid-feedback">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-6">
        <input type="text" class="form-control <?= ($validation->hasError('stok_tersedia'))? 'is-invalid' : '' ; ?>" id="stok_tersedia" name="stok_tersedia" value="<?= (old('stok_tersedia')) ? old('stok_tersedia') : $produk['stok_tersedia']; ?>">
        <div class="invalid-feedback">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-2">
            <img src="<?= base_url('img/toko/produk/'.$produk['gambar_produk']); ?>" class="img-thumbnail img-preview">
        </div>
        <div class="col-sm-4">
