<div class="modal fade" id="modalformedit" tabindex="-1" aria-labelledby="modalformeditLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <input type="hidden" name="idsatuan" id="idsatuan" value="<?= $idsatuan; ?>">
            <div class="modal-body">
                <div class="form-group">
                    <label for="">Nama Satuan</label>
                    <input type="text" name="namasatuan" id="namasatuan" class="form-control form-control-sm"
                        required value="<?= $namasatuan; ?>">
                </div>
            </div>
